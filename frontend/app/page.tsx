...
export default function Home() {
  ...
  return (
    <div className="grain min-h-screen flex flex-col">
      {/* Header */}
      <header className="border-b border-ink-800 px-4 sm:px-8 py-4 sm:py-5 flex items-center gap-3">
        <Link href="/" className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-amber-500 flex items-center justify-center">
            <GitCompare className="w-4 h-4 text-ink-950" />
          </div>
          <span className="font-serif text-lg sm:text-xl font-semibold text-ink-100">PolicyLens</span>
        </Link>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-10 sm:py-16">
        {/* Hero */}
        <div className="text-center mb-10 sm:mb-14 max-w-2xl animate-slide-up">
          <h1 className="font-serif text-3xl sm:text-5xl font-bold text-ink-50 mb-4 leading-tight">
            Policy Document<br />
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 justify-center mb-8 sm:mb-12 px-2">
          {[
            ...
            <div key={label} className="flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-ink-900 border border-ink-700 text-ink-400 text-xs sm:text-sm">
